...
const Section = ({ children, className = "", gradient = false, id }) => (
  <section
    id={id}
    className={`py-12 sm:py-16 md:py-20 lg:py-28 w-full overflow-x-hidden ${gradient ? "bg-gradient-to-b from-card/30 to-background" : ""} ${className}`}
  >
    <div className="container mx-auto px-4 sm:px-6 md:px-6 max-w-full">
      {children}
    </div>
  </section>
);
